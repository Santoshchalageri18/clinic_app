    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-3 pr-10 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-400"
        />
        <svg
      ...
      <div className="space-y-3">
        {filteredDoctors.map((doctor) => {
          ...
          return (
            <div
              key={doctor.id}
              className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all"
            >
              {/* Header */}
              <div className="p-4">
              ...
              >
                <div className="px-4 pb-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Session mode</p>
                      <p className="font-medium text-gray-900 text-sm">
                        {doctor.sessionMode}
                      </p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Session Fee</p>
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-gradient-to-r from-pink-300 to-purple-300 hover:from-pink-400 hover:to-purple-400 text-gray-900 font-medium rounded-xl transition-all active:scale-95 shadow-sm"
                  >
                    Book Now
                  </button>
                </div>
